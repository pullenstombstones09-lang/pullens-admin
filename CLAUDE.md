...
**Wage increases applied** from `C:\Users\Annika\Desktop\Allandale Wage Increase 2026.docx` — TWO passes. First pass used XML-strip extraction which collapsed table whitespace and slipped 5 wage values to the wrong rows. Annika spotted the mismatch. Re-extracted via cell-by-cell parsing (System.Xml.XmlNamespaceManager on `w:tbl/w:tr/w:tc`) — verified DB now matches all 38 doc rows exactly. **First-pass mistakes corrected:** PT013 Alli R1230.50→**R1305** (was missed), PT014 Enrique R1418→**R1210** (reverted — wrongly bumped), PT015 Cherylette R1337.50→**R1418** (was missed), PT024 Gugu R1351→**R1340** (reverted), PT040 Thobeka R1331→**R1340** (verbal R1331 overridden by doc R1340). Final wage set (DB == doc): PT001 R2350, PT002 R2715, PT005 R2036, PT006 R1850, PT007 R2543, PT008 R1540, PT009 R2774, PT012 R1500, PT013 R1305, PT015 R1418, PT017 R1396, PT018 R1443, PT028 R2410, PT030 R1496, PT039 R1500, PT040 R1340 — all others unchanged at R1210 or pre-existing. All updates + corrections audit-logged. **Methodology note for next session: never trust XML-strip extraction on Word tables; always use `w:tc` cell extraction.**
