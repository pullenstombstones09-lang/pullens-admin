    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-5">
        {[
          ...
          >
            ...
            <div>
              <p className="text-lg font-bold text-[var(--foreground)] leading-none">{item.count}</p>
      ...
      {publicHoliday && (
        <div className="rounded-xl bg-blue-50 border border-blue-200 px-5 py-4 flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-[var(--foreground)]">Public Holiday — {publicHoliday}</p>
      ...
      {user?.role === 'owner' && (
        <Card padding="sm">
          <details>
            <summary className="cursor-pointer text-sm font-semibold text-[var(--foreground)] select-none py-2">
      ...
      {showSavedOverlay && (
        <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
          ...
          >
            ...
            <p className="text-xl font-bold text-[var(--foreground)]">Register Saved</p>
